...
import { FaShieldAlt, FaExclamationTriangle, FaExternalLinkAlt, FaSync, FaClock } from 'react-icons/fa'
...
const SecurityNews = () => {
  ...
  const NewsCard = ({ item, source, index, sourceColor }) => (
    <motion.div
      ...
      className="group bg-tokyo-night-bg-alt/50 hover:bg-tokyo-night-bg-alt rounded-xl p-5 border-l-4 border-tokyo-night-border hover:border-tokyo-night-cyan transition-all duration-300 mb-4 shadow-sm hover:shadow-lg"
    >
      <div className="flex items-start gap-3">
        <div className={`flex-shrink-0 w-2 h-2 rounded-full mt-2 ${sourceColor}`}></div>
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 text-xs text-tokyo-night-fg/50">
            ...
            <span className={`px-2 py-0.5 rounded text-[10px] font-medium ${source === 'THN' ? 'bg-tokyo-night-cyan/20 text-tokyo-night-cyan' : 'bg-tokyo-night-red/20 text-tokyo-night-red'}`}>
              {source}
            </span>
          </div>
        </div>
            ...
            <div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-tokyo-night-fg/50 mt-0.5">Tin tức bảo mật tổng hợp</p>
                </div>
              </motion.div>
            ...
            <div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-tokyo-night-fg/50 mt-0.5">Cảnh báo lỗ hổng nghiêm trọng</p>
                </div>
              </motion.div>
